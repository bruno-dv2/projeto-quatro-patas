  ...
  const criterios = [
    {
      ...
      titulo: "Pesquisa",
      descricao:
        "Iniciamos nosso processo seletivo, pesquisando por ONGs nas redes sociais mais famosas e via navegadores populares.",
    },
    {
      icone: "📍",
      titulo: "Validação da Localização",
      descricao:
        "Verificar se a ONG pode ser localizada via aplicativo geolocalizador, se a mesma permite visitas abertas ao espaço, ajuda a comprovar a seriedade do trabalho.",
    },
    {
      icone: "✅",
      titulo: "Dados Validados",
      descricao:
        "Clareza do processo de adoção. - Verificar se os dados bancários são correspondentes ao da ONG. - ONGs transparentes, publicam feedbacks, do destino, de suas arrecadações.",
    },
  ];

  return (
    <section id="ongs-selected" className="py-16 px-8 bg-white">
